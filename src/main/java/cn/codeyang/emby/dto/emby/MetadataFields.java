...
public enum MetadataFields {
    CAST("Cast"), GENRES("Genres"), PRODUCTIONLOCATIONS("ProductionLocations"), STUDIOS("Studios"), TAGS("Tags"), NAME("Name"), OVERVIEW("Overview"), RUNTIME("Runtime"), OFFICIALRATING("OfficialRating"), COLLECTIONS("Collections"), CHANNELNUMBER("ChannelNumber"), SORTNAME("SortName"), ORIGINALTITLE("OriginalTitle"), SORTINDEXNUMBER("SortIndexNumber"), SORTPARENTINDEXNUMBER("SortParentIndexNumber"), COMMUNITYRATING("CommunityRating"), CRITICRATING("CriticRating"), TAGLINE("Tagline");
