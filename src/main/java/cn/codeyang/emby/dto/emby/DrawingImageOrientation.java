...
public enum DrawingImageOrientation {
    TOPLEFT("TopLeft"), TOPRIGHT("TopRight"), BOTTOMRIGHT("BottomRight"), BOTTOMLEFT("BottomLeft"), LEFTTOP("LeftTop"), RIGHTTOP("RightTop"), RIGHTBOTTOM("RightBottom"), LEFTBOTTOM("LeftBottom");
